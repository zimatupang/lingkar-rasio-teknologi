    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="https://i.pinimg.com/originals/f9/6a/26/f96a261e5a60d7d66b36e2850e3eb19b.png" style="width:100%; max-width:300px;">
                            </td>
            ...
            <tr class="total">
                ...
                <td>
                   Total: Rp <?php echo $data_produk['harga'] * $jumlah;?>
                </td>
            </tr>
        </table>
    </div>
